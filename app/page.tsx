    ...
    <div>
      ...
      <section className="border-y border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { abbr: "OST", title: "Osteopatía", desc: "D.O. — formación internacional" },
            { abbr: "KIN", title: "Kinesiología", desc: "Rehabilitación y readaptación deportiva" },
            { abbr: "POST", title: "Posturología", desc: "Evaluación y corrección postural" },
            { abbr: "PNI", title: "PNI Clínica", desc: "Psiconeuroinmunología aplicada" },
          ].map((cred) => (
            <div
              key={cred.title}
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-teal-50 flex items-center justify-center">
                <span className="text-teal-700 text-lg font-bold">{cred.abbr}</span>
              </div>
              <div>
